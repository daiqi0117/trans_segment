...
# 定义文件夹路径
point_cloud_folder = 'output_train'  # 点云文件存放路径
superpoint_folder = 'super_train_50_10_50/updated_superpoint'  # 超点文件存放路径
output_folder = 'updated_superpoints/train/txt'  # 更新后的超点文件存放路径
